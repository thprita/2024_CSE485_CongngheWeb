            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    if (isset($_GET['msg']) && $_GET['msg'] === 'error') {
                        echo '<div class="alert alert-success" role="alert">Thông tin tài khoản sai</div>';
                    }
                    ?>
                    <div class="card-body">
                        <form action="?controller=login&action=xuly" method="post">
                            ...
                            <button type="submit" class="btn btn-primary " style="float:right" name="dangnhap">ĐĂNG NHẬP</button>
                            <!-- <a href="?controller=signup" class="btn btn-primary ">ĐĂNG KÝ</a> -->
                        </form>
                    </div>
                </div>
            </div>
